...
export default function RegisterPage() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Automatically log them in by fetching a token right after
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
                <div className="w-full max-w-md">
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-serif font-bold text-[#2A3B47] mb-2">Create Account</h2>
                        <p className="text-gray-500 font-medium tracking-wide">Join PrakritiAI to start your journey</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <div>
                            <select
                                ...
                                className="w-full px-5 py-4 rounded-xl border border-gray-200 focus:border-[#2D7A5D] focus:ring-1 focus:ring-[#2D7A5D] outline-none transition-all text-sm bg-gray-50/50 appearance-none text-[#2A3B47] font-medium"
                            >
                                <option value="PATIENT">🌿 I am seeking Wellness (Patient)</option>
                                <option value="PRACTITIONER">🩺 I am a Doctor / Practitioner</option>
                            </select>
                        </div>
                    ...
                    <p className="text-center text-sm font-medium text-gray-500 mt-6">
                        Already have an account? <Link href="/login" className="text-[#2D7A5D] font-bold hover:underline">Sign in</Link>
                    </p>
                </div>
            </div>
        </div>
