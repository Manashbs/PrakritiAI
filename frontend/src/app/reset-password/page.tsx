...
export default function ResetPasswordPage() {
    return (
        <Suspense fallback={<div className="flex min-h-screen items-center justify-center bg-gray-50"><p className="text-gray-500 font-medium tracking-wide animate-pulse">Loading secure connection...</p></div>}>
            <ResetPasswordForm />
        </Suspense>
    );
}
